...
// Ef temporal: O(n), generación de variables, accesos a campos de registros en memoria dinámica y setteo de estos campos
...
//                       - con 2 espacios las variables locales temp y actual.
...
/* NO SERÍA DE O(1) PORQUE SE DEBE RECORRER LA LISTA PARA LLEGAR 
   AL FINAL Y AGREGAR EL NUEVO NODO
void Append(LinkedListSt* xs, LinkedListSt* ys) {
    if (xs->primero == NULL) {
